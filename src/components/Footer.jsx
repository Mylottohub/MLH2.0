            ...
            <div className="container">
              ...
              <div className="row">
                ...
                <div className="text-center">
                 ...
                 <a href="https://mylottohub.com/responsible-gaming-player-protection" target="_blank" className="btn text-white w-50 mx-auto">Click here to read Responsible Gaming</a>
              </div>
            </div>
          </div>
